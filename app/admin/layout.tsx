    ...
    try {
      ...
      if (user?.role === "ADMIN") {
        ...
        toast.error("Access denied", {
          description: "The admin portal is restricted to authorized staff only.",
          duration: 5000,
        });
      }
    } catch {
        ...
        <div className="flex flex-col items-center gap-5 text-center max-w-sm">
          ...
          <div>
            ...
            <p className="text-sm text-muted-foreground">
              The admin portal is only accessible to authorized Cliq Edu Loan staff.
            </p>
          </div>
          <div className="flex gap-3">
            ...
            <Link href="/apply">
              <Button size="sm">Apply for Loan</Button>
            </Link>
          </div>
        </div>
      </div>
