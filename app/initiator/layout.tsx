    ...
    try {
      ...
      if (user?.role === "INITIATOR" || user?.role === "ADMIN") {
        ...
        toast.error("Access denied", {
          description:
            "The initiator portal is restricted to authorized staff only.",
          duration: 5000,
        });
      }
    } catch {
        ...
        <div className="flex flex-col items-center gap-5 text-center max-w-sm">
          ...
          <div>
            ...
            <p className="text-sm text-muted-foreground">
              The initiator portal is only accessible to authorized Unnati
              staff.
            </p>
          </div>
  ...
  return (
    <PermissionProvider>
      <div className="flex bg-muted/30 min-h-screen lg:h-screen lg:overflow-hidden">
        <DynamicSidebar
          portalBadge="INITIATOR"
          portalTitle="Initiator Portal"
          fallbackName="Unnati Initiator"
