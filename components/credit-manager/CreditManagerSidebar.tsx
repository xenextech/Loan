...
const NAV_GROUPS = [
  ...
  },
  {
    ...
    items: [
      {
        href: "/credit-manager/applications",
        icon: FileText,
        label: "Applications",
        exact: false,
      },
      {
        href: "/credit-manager/approval",
        icon: GitBranch,
        label: "Approval Work Flow",
        exact: false,
      },
      {
        href: "/credit-manager/disbursment",
        icon: Wallet,
        label: "Disbursement",
        exact: false,
      },
  ...
  },
  {
    ...
    items: [
      {
        href: "/credit-manager/document-center",
        icon: FolderOpen,
        label: "Document Center",
        exact: false,
      },
      {
        href: "/credit-manager/insurance-checker",
        icon: ShieldCheck,
  ...
  },
  {
    ...
    items: [
      {
        href: "/credit-manager/commission",
        icon: Percent,
        label: "Commission",
        exact: false,
      },
      {
        href: "/credit-manager/audit-ledger",
        icon: History,
        label: "Audit Ledger",
        exact: false,
      },
...
export default function CreditManagerSidebar() {
      ...
      <Sheet open={mobileOpen} onOpenChange={setMobileOpen}>
        <SheetContent side="left" className="w-60 p-0">
          <SheetHeader className="sr-only">
            <SheetTitle>Credit Manager Navigation</SheetTitle>
          </SheetHeader>
