 ...
 * the same pair the Supporter and Checker review screens use.
 */
export function useApproverApplicationDetail(id: string): {
  data: ApproverApplicationDetail | undefined;
  isLoading: boolean;
  isNotFound: boolean;
} {
  ...
  const data: ApproverApplicationDetail | undefined =
