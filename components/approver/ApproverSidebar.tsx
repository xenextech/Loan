...
const NAV_GROUPS = [
  ...
  },
  {
    ...
    items: [
      {
        href: "/approver/emi-schedule",
        icon: Calendar,
        label: "EMI Schedule",
        exact: false,
      },
      {
        href: "/approver/notification",
        icon: Inbox,
        label: "Inbox",
        exact: false,
      },
  ...
  },
  {
    ...
    items: [
      {
        href: "/approver/document-center",
        icon: FolderOpen,
        label: "Document Center",
        exact: false,
      },
      {
        href: "/approver/insurance-checker",
        icon: ShieldCheck,
  ...
  },
  {
    ...
    items: [
      {
        href: "/approver/commission",
        icon: Percent,
        label: "Commission",
        exact: false,
      },
      {
        href: "/approver/audit-ledger",
        icon: History,
        label: "Audit Ledger",
        exact: false,
      },
        ...
        <div className="flex items-center gap-2.5 px-3 py-2.5">
          ...
          <div className="min-w-0 flex-1">
            ...
            <p className="text-[10px] text-muted-foreground truncate">
              {displayName(user, "Unnati Approver")}
            </p>
          </div>
        </div>
        <button
      ...
      <Sheet open={mobileOpen} onOpenChange={setMobileOpen}>
        <SheetContent side="left" className="w-60 p-0">
          <SheetHeader className="sr-only">
            <SheetTitle>Approver Navigation</SheetTitle>
          </SheetHeader>
