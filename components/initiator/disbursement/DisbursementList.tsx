...
export function DisbursementList() {
  ...
  const { data: applications, isLoading } = useDisbursements();
    ...
    <div className="p-6 lg:p-8">
      <motion.div initial={{ opacity: 0, y: 12 }} animate={{ opacity: 1, y: 0 }} className="mb-8">
        ...
        <p className="text-sm text-muted-foreground mt-1">
          Applications in the disbursement pipeline, awaiting conditions and fund release.
        </p>
      </motion.div>
                ...
                <TableBody>
                  {filtered.map((app) => (
                    <TableRow
                      ...
                      onClick={() => router.push(`/initiator/disbursment/${app.id}`)}
                    >
                      ...
                      <TableCell className="py-3.5 text-right pr-5">
                        <Button
                          ...
                          onClick={(e) => {
                            e.stopPropagation();
                            router.push(`/initiator/disbursment/${app.id}`);
                          }}
                        >
                          View
                        </Button>
