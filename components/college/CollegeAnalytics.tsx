...
const KPI_STATS = [
  {
    label: "Admission conversion (with loan)",
    value: "84%",
    sub: "↑ 11% vs no-loan",
    positive: true,
  },
  ...
  {
    label: "Dropout — loan cohort",
    value: "1.2%",
    sub: "vs 8.4% non-loan",
    positive: true,
  },
  {
    label: "Avg bank processing",
    value: "5.8 days",
    sub: "↓ 2.4 days faster",
    positive: true,
  },
    ...
    <div className="p-6 lg:p-8 max-w-6xl">
      ...
      >
        ...
        <p className="text-sm text-muted-foreground mt-1">
          Loan uptake, fee collection, and bank performance insights for your
          institution.
        </p>
      </motion.div>
            ...
            <Card className="border-border shadow-none">
              <CardContent className="px-5 py-5">
                ...
                <div className="flex items-center gap-1 mt-1">
                  ...
                  <p className="text-[11px] text-[oklch(0.42_0.18_145)]">
                    {s.sub}
                  </p>
                </div>
              </CardContent>
                ...
                <Table>
                  ...
                  <TableBody>
                    {BANK_SCORECARD.map((b) => (
                      ...
                      >
                        <TableCell className="pl-5 py-2.5 text-xs font-medium text-foreground">
                          {b.bank}
                        </TableCell>
                        <TableCell
                          className={`py-2.5 text-xs font-semibold ${b.positive ? "text-[oklch(0.42_0.18_145)]" : "text-[oklch(0.55_0.18_80)]"}`}
                        >
                          {b.sanction}
                        </TableCell>
            ...
            <Card className="border-border shadow-none">
              ...
              <CardContent className="p-0">
                <Table>
                  <TableHeader>
                    <TableRow className="hover:bg-transparent border-border">
                      <TableHead className="text-[10px] pl-5">
                        Student
                      </TableHead>
                    ...
                    {FEE_COLLECTION.map((f) => (
                      ...
                      >
                        ...
                        <TableCell className="py-3">
                          <Badge
                            className={`text-[9px] font-semibold ${statusBadgeStyle[f.statusType]}`}
                          >
                            {f.status}
                          </Badge>
                        </TableCell>
