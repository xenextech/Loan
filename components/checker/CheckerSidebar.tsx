...
const NAV_GROUPS = [
  ...
  },
  {
    ...
    items: [
      {
        href: "/checker/applications",
        icon: FileText,
        label: "Applications",
        exact: false,
      },
      {
        href: "/checker/approval",
        icon: GitBranch,
        label: "Approval Work Flow",
        exact: false,
      },
      {
        href: "/checker/disbursment",
        icon: Wallet,
        label: "Disbursement",
        exact: false,
      },
  ...
  },
  {
    ...
    items: [
      {
        href: "/checker/document-center",
        icon: FolderOpen,
        label: "Document Center",
        exact: false,
      },
      {
        href: "/checker/insurance-checker",
        icon: ShieldCheck,
  ...
  },
  {
    ...
    items: [
      {
        href: "/checker/commission",
        icon: Percent,
        label: "Commission",
        exact: false,
      },
      {
        href: "/checker/audit-ledger",
        icon: History,
        label: "Audit Ledger",
        exact: false,
      },
      ...
      <Sheet open={mobileOpen} onOpenChange={setMobileOpen}>
        <SheetContent side="left" className="w-60 p-0">
          <SheetHeader className="sr-only">
            <SheetTitle>Checker Navigation</SheetTitle>
          </SheetHeader>
