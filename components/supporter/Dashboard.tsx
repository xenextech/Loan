...
import { Search, ClipboardCheck, ClipboardList } from "lucide-react";
...
export default function SupporterDashboard() {
  ...
  const { data: applications, isLoading } = useSupporterApplications();
  ...
  return (
    <div className="p-6 lg:p-8">
      <motion.div
        ...
        className="mb-8"
      >
        <h1 className="text-2xl font-bold text-foreground">Supporter Dashboard</h1>
        <p className="text-sm text-muted-foreground mt-1">
          Applications approved by the Initiator, awaiting Support review.
        </p>
      </motion.div>
            ...
            {isLoading ? (
              ...
              <div className="flex flex-col items-center justify-center py-24 gap-3">
                ...
                <p className="text-xs text-muted-foreground">
                  Applications will appear here once approved by the Initiator.
                </p>
              </div>
            ) : (
              <Table>
                ...
                <TableBody>
                  {filtered.map((app) => (
                    <TableRow
                      ...
                      onClick={() => router.push(`/supporter/applications/${app.id}`)}
                    >
                      ...
                      <TableCell className="py-3.5">
                        <Badge className="bg-primary/10 text-primary border-0 text-[10px] font-semibold gap-1">
                      ...
                      <TableCell className="py-3.5 text-right pr-5">
                        <Button
                          ...
                          onClick={(e) => {
                            e.stopPropagation();
                            router.push(`/supporter/applications/${app.id}`);
                          }}
                        >
                          View
                        </Button>
