...
export function SubmittedApplications() {
  ...
  return (
    <div className="p-6 lg:p-8">
      ...
      >
        <div>
          <h1 className="text-2xl font-bold text-foreground">Submitted Applications</h1>
      ...
      {isLoading ? (
        ...
        <div className="flex flex-col items-center justify-center py-20 text-center">
          ...
          <h2 className="text-lg font-bold text-foreground mb-2">No submitted applications yet</h2>
