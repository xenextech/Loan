...
function buildLoanProposalLetterHtml(
  ...
  const termsClauses = [
    "क) कर्जा पूर्णरूपमा चुक्ता नगरेसम्म वा कुनै दायित्व बाँकी रहेसम्म ऋणीले शर्तहरू अविच्‌छिन्न पालना गर्नुपर्नेछ ।",
    "ख) ऋणीले नेपालको प्रचलित कानून, नेपाल राष्ट्र बैंकले जारी गरेको निर्देशन तथा शर्तहरू वित्तीय संस्थाका समय-समयमा तोकेको पालना गर्न स्वीकार गर्नुपर्नेछ ।",
    "ग) ऋणीको कुनै विवरण परिवर्तन भएमा तुरुन्त वित्तीय संस्थालाई जानकारी दिनुपर्नेछ।",
    "घ) ऋणी तथा एकाघर परिवार, व्यक्तिगत जमानतकर्ताले वित्तीय संस्थाको ०.५% भन्दा बढी शेयर धारण गर्न पाइने छैन (राष्ट्र बैंकले तोकेको सीमाभन्दा बढी हुन नहुने)।",
    "ङ) ऋणीले वित्तीय संस्था विरुद्ध मुद्दा मामिला गरेमा वित्तीय संस्थाले तुरुन्त सम्पूर्ण लेना फिर्ता माग गर्नेछ।",
    "च) कर्जा तथा व्याज नतिरेमा वा कालोसूची निर्देशन विपरीत कार्य गरेमा कर्जा सूचना केन्द्रको कालोसूचीमा राखिनेछ ।",
    "छ) ऋणीको वित्तीय संस्थामा रहेको मुद्दती, चल्ती, बचत खाताको रकम कट्टा गरी व्याज, साँवा, शुल्क असुल गर्ने अधिकार वित्तीय संस्थालाई रहनेछ ।",
    "ज) ऋणीले यसै वित्तीय संस्थामा चल्ती/बचत खाता खोली कारोबार गर्नुपर्नेछ। अन्य संस्थामा कर्जा भए उक्त विवरण वित्तीय संस्थालाई दिनुपर्नेछ ।",
    "झ) सूचना, पत्राचार गर्दा खाता खोल्दा दिएको ठेगानामा गरिनेछ ।  ठेगाना परिवर्तन भएमा वित्तीय संस्थालाई लिखित जानकारी दिनुपर्नेछ,नदिएमा सोही ठेगानामा गरिएको सञ्चार आधिकारिक मानिनेछ ।",
    "ञ) चेकबुक, स्टेटमेन्ट, कार्ड, डिजिटल बैंकिङ विवरण गोप्य र सुरक्षित राख्नु ऋणीको जिम्मेवारी हुनेछ । ऋणीको कमजोरीबाट भएको हानीको जिम्मेवारी ऋणी स्वयंले लिनु पर्नेछ ।",
    "ट) नेपाल राष्ट्र बैंकको ग्राहक संरक्षण निर्देशन बमोजिम वित्तीय संस्था ग्राहक हित संरक्षणका लागि सदैव प्रतिबद्ध रहनेछ।",
  ];

  // The paper runs these as one continuous block, not as separate list items.
  const defaultBlock =
    "क) कर्जा किस्ता तिर्नुपर्ने तालिका अनुसार भुक्तानी नभएमा वा बीमा प्रिमियम वा अन्य लेना बाँकी रहेमा ।" +
    "ख) कर्जा सम्झौता वा यस प्रस्ताब पत्रको कुनै शर्त उल्लङ्घन भएमा ।" +
    "ग) स्वीकृत कर्जा रकम कानूनद्वारा वर्जित कार्यमा कर्जा लिँदा उल्लेख गरिएको उद्देश्यबाहेक अन्य प्रयोजनका लागि प्रयोग गरेमा ।" +
    ...
    "ठ) ऋणी अपराधिक गतिविधिमा संलग्न प्रमाणित भएमा";

  const defaultActions = [
    "(१) सम्पूर्ण साँवा/व्याज/लेना फिर्ता माग गर्ने,",
    "(२) हर्जाना ब्याज लगाउने,",
    "(३) धितो कब्जा गरी बिक्री प्रक्रिया थाल्ने,",
    "(४) यस प्रस्ताब पत्रको सबै शर्त भंग मानी कानूनी कारबाही सम्बन्धी प्रक्रिया अगाडि बढाउने,",
    "(५) ऋणीका सबै अधिकार स्वतः निलम्बन गर्ने,",
    "(६) कालोसूचीमा राख्ने । ऋणीको जुनसुकै खाताबाट रकम कट्टा गर्न सक्ने ।",
  ];
  ...
  <div class="body-text">
   तपाईं श्री ${fill(studentName, "lg")} (यस पछि ऋणी भनिएको) ले यस वित्तीय संस्थामा मिति ${applicationDate} मा दिएको कर्जा आवेदन पत्र र सो साथ संलग्न विवरणहरुको आधारमा र यस संस्थामा यस पछि वित्तीय संस्था भनिएको विच सम्पन्न विभिन्न चरणको छलफल, वार्तालाप तथा तहाँबाट कर्जा प्राप्त गर्न उपलब्ध गराइएका विभिन्न कागजातहरु समेतको आधारमा निम्न बमोजिमको कर्जा सुविधा निम्न शर्त बन्देजहरुको अधिनमा रहनेगरी स्वीकृत गरिएको व्यहोरा अनुरोध छ ।
  </div>

  <table>
    <tbody>
      <tr><th style="width:6%">१.</th><th colspan="2">कर्जा तथा सुविधाको विवरण</th></tr>
      <tr><td>${hl("क.")}</td><td style="width:26%">${hl("कर्जा सुविधा किसम")}</td><td>${hl("शैक्षिक कर्जा")}</td></tr>
  ...
  <table>
    <tbody>
      <tr><td style="width:6%">क.</td><td style="width:20%">अन्य</td><td>कर्जा प्रशासनिक दस्तुर वापत स्वीकृत ${fill(null, "sm")}कर्जा रकमको ${fill(null, "sm")} प्रतिशत (जम्मा रू.${fill(null, "sm")}) यस वित्तीय संस्थामा रहेको तपाईको खाताबाट कट्टा गरिनेछ ।कर्जा सूचना शुल्क वास्तविक खर्च भए बमोजिम लाग्नेछ ।कर्जा सम्बन्धी अन्य फि, शुल्क, दै–दस्तुर समय समयमा वित्तीय संस्थाले तोके अनुसार हुनेछ । साथै, त्यस्तो शुल्क, दै–दस्तुर आदि वित्तीय संस्थाको Standard Tariff of Charges (STC) बमोजिम हुनेछन् । सो सम्बन्धी जानकारी वित्तीय संस्थाको वेबसाइट ${esc(data.tariffUrl ?? "https://bestfinance.com.np/standard-tariff-charges/")} मा समेत हेर्न सकिनेछ ।</td></tr>
    </tbody>
  </table>

  <h2 class="section">३. धितो सुरक्षण</h2>
  <p class="body-text">ऋणीले निम्न सुरक्षण कागजातहरूमा हस्ताक्षर गर्नु गराउनु पर्नेछ ।</p>
  ${clauseListHtml([
    ("१. कर्जा प्रस्ताव पत्रमा स्वीकृति"),
    ("२. कर्जा लेखत"),
    (`३. श्री ${fill(studentName, "md")} को व्यक्तिगत जमानत`),
    ("४. कालोसूचीमा राख्नेमा मञ्जुरीनामा"),
    ("५. कर्जा रकम खातामा राखिदिन अनुरोध पत्र"),
    ("६. सम्बन्धित क्याम्पस/यूनिभर्सिटी/इन्स्टिच्युटको सिफारिस पत्र"),
  ])}

  <h2 class="section">४. भुक्तानी विधि</h2>
  <p class="body-text">वुंदा नं. ३ मा उल्लेख गरिएनुसारको सम्पूर्ण सुरक्षण लिखतहरुमा सहिछाप/पारित भए पश्चात ऋणीले कर्जा रकम खातामा राखिदिन अनुरोध गरे बमोजिम तथा कर्जाका सम्पूर्ण शर्तहरु नियमित परिपालना गर्ने गरी स्वीकृत कर्जा रकमको हदसम्म कर्जा रकम ऋणीको खातामा जम्मा हुनेछ । मासिक किस्ता चुक्ता गर्नका लागि तपाईंको खातामा रकम व्यवस्था जम्मा गरेको हुनुपर्ने छ । <span class="hl">(In case of the Moratorium)  तत्पश्चात् ${data.gracePeriodMonths ? fillNum(data.gracePeriodMonths, "xs") + " " : ""}महिना/वर्षसम्म ऋणीलाई प्रवाहित कर्जाको साँवामा दैनिक आधारमा ब्याज गणना गरी प्रत्येक अङ्ग्रेजी महिनाको १) तारिखमा उक्त ब्याज भुक्तानी गर्नुपर्नेछ । </span>सो रकम प्रत्येक अंग्रेजी महिनाको १० तारिखका दिन तपाईंको खाताबाट स्वतः कट्टी हुनेछ । तपाईंको कुनै पनि किस्ता बाँकी रहेमा वा कर्जा चुक्ता नभएमा, तपाईंको तथा तपाईंको एकाघर परिवारको वित्तीय संस्था वा अन्य कुनै पनि बैंक तथा वित्तीय संस्थामा जम्मा रहेको निक्षेपबाट रकम कट्टा गरी गराइ बाँकी लेना असुल गर्न सक्ने अधिकार वित्तीय संस्था संग सुरक्षित रहने छ ।</p>

  <h2 class="section">५. ब्याज गणनाको तरिका</h2>
  <p class="body-text">कर्जामा लाग्ने ब्याजदर वित्तीय संस्थाको प्रचलित आधार दर मा स्वीकृत प्रिमियम थप गरी निर्धारण गरिनेछ। वित्तीय संस्थाको आधार दरमा हुने परिवर्तनका कारण लागू ब्याजदर समय–समयमा परिवर्तन हुन सक्नेछ । प्रत्येक महिना बाँकी रहेको साँवामा सोही दरले ब्याज लाग्नेछ र उक्त ब्याज मासिक किस्तामा समावेश गरी भुक्तानी लिइनेछ। तर यस ऋण प्रस्ताब पत्रमा उल्लेखित शर्तहरुको बर्खिलाप हुने गरी तोकिएको समयमा साँवा तथा व्याज भुक्तानी नगरेमा सम्पूर्ण कर्जा रकममा (वक्यौता समेत) शर्त नं. १ अनुसार वित्तीय  संस्थाले निर्धारण गरेको व्याजदरमा भाखा नाघेको साँवा रकममा २ प्रतिशत वा नेपाल राष्ट्र बैंकले तोकिदिए बमोजिम थप गरी हर्जाना व्याज पूर्व सूचना नदिइकनै लगाउन सकिनेछ ।</p>

  <h2 class="section">६. बिमा</h2>
  <p class="body-text">यस कर्जा लिनका लागि तपाई ऋणी र यस कर्जाका लागि व्यक्तिगत जमानत लिने श्री ${fill(guarantorParty.name, "md")} को ग्रुप इनफिनिटी इन्सुरेन्स गराउनु पर्नेछ । त्यसरी बीमा गराइसकेपछि वित्तीय संस्थाको नाममा दरखास्त गरिएको सक्कल बीमा अभिलेख वित्तीय संस्थामा बुझाउनु पर्नेछ । तोकिएको समयमा वित्तीय संस्थाको नाममा दरपिठ गरिएको सक्कल बीमा अभिलेख वित्तीय संस्थामा नबुझाएमा वा बीमा अभिलेख नवीकरण गर्नुपर्ने हकमा नवीकरण गर्न नसकेको खण्डमा वित्तीय संस्था स्वयंले बीमा वा बीमा नवीकरण व्यवस्था गर्न सक्नेछ र त्यस वापत लाग्ने खर्च ऋणीको खाताबाट कट्टा गरिनेछ । सो खर्च ऋणीले नबुझाएसम्मको अवधिका लागि संस्थाले निर्धारण गरेको आधारदरमा अधिकतम ५ प्रतिशत प्रिमियम लगाइनेछ । वित्तीय संस्थाबाट पनि उक्त बीमा नवीकरण गराउन छुट हुन गएमा त्यसको जिम्मेवारी ऋणीको नै हुनेछ ।</p>
  ...
  <p class="body-text">कुनै पनि किस्ता नबुझाएमा, वा कुनै शर्त उल्लङ्‍घन गरेमा वित्तीय संस्थाले बाँकी सम्पूर्ण साँवा, ब्याज, हर्जाना, प्रशासनिक खर्च, कानुनी खर्च, असुल खर्च आदि एकमुष्ट माग गर्न सकिनेछ । त्यस पछि प्रचलित कानून बमोजिम कर्जा असुली गर्नका लागि प्रक्रिया अगाडि बढाइनेछ ।</p>
  ...
  <p class="body-text">कर्जाको किस्ता तिर्नु पर्ने तलको कुनै एक अवस्था आएमा ऋणीलाई कर्जा तिर्न असफल भएको घोषणा गरी तुरुन्त कर्जा असुली प्रक्रिया थालिनेछ :</p>
  <p class="body-text">${defaultBlock}</p>
  <p class="body-text">ड) ऋणीले कर्जाको सावाँ व्याज नतिरेमा वा कर्जाको शर्त उलङघन गरेमा वित्तीय संस्थाले निम्न कार्य गर्न सक्नेछ :</p>
  ${clauseListHtml(defaultActions)}

  <h2 class="section">१२. लागू हुने पूर्व शर्त</h2>
  <p class="body-text">क) ऋणीलाई यस कर्जा प्रस्ताव पत्रमा उल्लेख गरिएका शर्तहरू स्वीकार्य भएमा यस प्रस्ताव पत्रको मितिले १५ दिनभित्र हस्ताक्षर गरी फिर्ता दिनुपर्नेछ।ख) प्रस्ताव स्वीकार गर्नुअगावै प्रतिकूल परिस्थिति आएमा वित्तीय संस्थाले कर्जा सुविधा प्रस्ताव फिर्ता लिने गर्न सक्नेछ।</p>

  <h2 class="section">१२. स्वघोषणा</h2>
  <p class="body-text">ऋणीले तलका विवरण सही र सत्य भएको बिना शर्त घोषणा गर्दछ : क) वित्तीय संस्थासँगको सबै कारोबारसम्बन्धी लिखतहरू कानूनी रूपमा म र जमानतकर्तालाई बन्धनकारी हुनेछन्। ख) हाल ऋणी वा जमानीकर्तामाथि कुनै मुद्दा चलिरहेको छैन। ग) मैले कुनै कानून वा इजाजतपत्रको विपरीत कार्य गरेको छैन। घ) मैले उपलब्ध गराएका सबै विवरण, प्रतिबद्धता, आवेदन, वित्तीय विवरण तार्किक रूपमा असत्य, गलत वा झुटो छैनन्। ङ) मेरो एकाघर परिवार, यस संस्थाको संस्थापक शेयरधनी, प्रमुख कार्यकारी, कर्मचारी र सोको एकाघर परिवार, प्रबन्धक एजेन्ट, लेखापरीक्षक, सल्लाहकार, आधिकारिक मूल्याङ्कनकर्ता वा तिनको परिवार सदस्य नरहेको र मेरो र घर परिवारको सदस्यको यस वित्तीय संस्थासँग कुनै वित्तीय स्वार्थ नरहेको घोषणा गर्दछु।च) मेरो एकाघर परिवार तथा जमानीदाताका नजिकका नातेदार यस वित्तीय संस्थामा प्रमुख कार्यकारी अधिकृत वा कर्मचारी नरहेको घोषणा गर्दछु।</p>
  ...
  <div class="guarantor-block">
    ...
    <p class="body-text">
      तपाई धनी ${fill(institutionName, "md")} ${branchName} शाखाबाट श्री ${fill(studentName, "md")} को नाममा जारी गरेको मिति ${bsDate} को ऋण प्रस्ताब पत्र उल्लिखित रकम  ${amountFigure(finalDisbursementAmount)} (अक्षरेपी ${amountRupeeWords(finalDisbursementAmount)}) वा सोको सट्टामा प्रतिस्थापन हुने अर्को पत्रमा उल्लिखित कर्जाको वर्तमान् तथा भविष्यमा उत्पन्न/सृजना हुने थप दायित्व समेत खाम्ने सम्मको लागि सुरक्षण कायम रहने कुरामा मेरो पूर्ण मञ्जुरी रहेको छ गर्दछु र निजले उक्त रकम नतिरेमा वा नबुझाएमा मैले तिर्नेछु | तिराउनेछु भनी व्यक्तिगत जमानत लेखी दिएको छु ।
    </p>
    <table class="sig-table">
      <tbody>
        <tr>
